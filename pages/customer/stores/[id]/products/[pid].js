...
export default function Product({ store, product }) {
  ...
  const handleBuy = async () => {
    try {
      ...
      total = total + (selectedColor === "" ? 0 : selectedColor.price);
      total = total + (selectedSize === "" ? 0 : selectedSize.price);
      total = total + (selectedTopping === "" ? 0 : selectedTopping.price);
      total = total + (selectedDose === "" ? 0 : selectedDose.price);
      const {
        data: { message, order },
          ...
          <div className="rounded-lg shadow w-full relative flex items-center bg-white px-4 pt-14 pb-8 overflow-hidden sm:px-6 sm:pt-8 md:p-6 lg:p-8">
            <div className="w-full grid grid-cols-1 gap-y-8 gap-x-6 items-start sm:grid-cols-12 lg:gap-x-8">
              ...
              <div className="grid content-between h-full sm:col-span-8 lg:col-span-7">
                <div>
                  <h3 className="text-xl font-bold tracking-wide">Distant Mountains Artwork Tee</h3>
                  ...
                  <p className="text-md text-gray-500 my-2">
                    ...
                    consequatur saepe fugiat voluptatum harum. Cumque ipsa deserunt, tempora, illum
                    omnis quis dignissimos iusto illo debitis voluptatibus ab dolor at.
                  </p>
